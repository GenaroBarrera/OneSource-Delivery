...
/**
 * This service contains a method sendLogin which sends a post request back to the server 
 * containing the user's credentials email and password, from which the server can then authenticate.
 * this service also allows us to persist a user by saving their credentials and id in local storage
 */
